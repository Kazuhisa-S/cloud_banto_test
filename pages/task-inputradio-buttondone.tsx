...
const TaskInputradioButtondone: NextPage = () => {
  return (
    <div className="relative bg-white w-full h-[1000px] overflow-x-auto text-left text-sm text-gray-200 font-noto-sans">
      ...
      <img
        ...
        src="/layer-41.svg"
      />
      <Component divPosition="absolute" divTop="687px" divLeft="649px" />
...
export default TaskInputradioButtondone;
